              ...
              {myCircles.map((circle) => (
                ...
                >
                  <CardHeader>
                    ...
                    <CardDescription>
                      {circle.teachers.length} members • {circle.status}
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-2">
                      {circle.teachers.slice(0, 3).map((teacher) => (
                        <div
                          key={teacher.id}
                      ...
                      {circle.teachers.length > 3 && (
                        <p className="text-sm text-muted-foreground">
                          +{circle.teachers.length - 3} more members
                        </p>
                      )}
                    </div>
                  </CardContent>
